...
const ingredientOptions = {
    // Create an array of protein options
    arrProtein: ["meat", "poultry", "seafood", "tofu", "beans"],
    // Create additional arrays for each protein option
    _meat: [
        "Beef",
        "Pork",
        "Lamb",
    ...
    // Create an array of dairy options
    arrDairy: ["milk", "cream", "cheese", "yogurt", "butter"],
    // Create additional arrays for each diary option
    _milk: [
        "Whole milk",
        "Skim milk",
        "Low-fat milk",
    ...
    arrMisc: ["bread", "pasta", "grain", "processed"],
    _bread: [
        "Baguette",
        "Brioche",
        "Challah",
